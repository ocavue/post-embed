...
it('parses start offsets', () => {
  expect(
    parseYouTubeUrl('https://youtu.be/aqz-KE-bpKQ?t=90')?.startSeconds,
  ).toBe(90)
  expect(
    parseYouTubeUrl('https://www.youtube.com/watch?v=aqz-KE-bpKQ&t=1m30s')
      ?.startSeconds,
  ).toBe(90)
  expect(
    parseYouTubeUrl('https://www.youtube.com/watch?v=aqz-KE-bpKQ&start=3723')
      ?.startSeconds,
  ).toBe(3723)
  expect(
    parseYouTubeUrl('https://www.youtube.com/watch?v=aqz-KE-bpKQ&t=later')
      ?.startSeconds,
  ).toBe(0)
})
