...
export function createYouTubeSnapshot(
  name: YouTubeSnapshot,
): YouTubeVideo | null {
  if (name === 'missing') return null
  if (name === 'invalid') return { title: 42 } as unknown as YouTubeVideo
  const video: YouTubeVideo = {
    url: 'https://www.youtube.com/watch?v=aqz-KE-bpKQ',
    title: 'Big Buck Bunny 60fps 4K - Official Blender Foundation Short Film',
    author_name: 'Blender',
    author_url: 'https://www.youtube.com/@BlenderOfficial',
    thumbnail_url: new URL('/media/poster.svg', window.location.origin).href,
    thumbnail_width: 480,
